	    ...
	    if (!isArgsError) {
	        ...
	        switch (arguments.length) {
	            ...
	            case 3:
	                ...
	                begin = arguments[2] - 1;//5.0 Decremented index
	            case 2:
	                sep = arguments[1];
	            default:
	                break;
...
if (typeof(kony.os) == "undefined"){
	...
	kony.os.formatDate = function (d1, sfrmt, tgtfrmt) {
		...
		if(d1 == null || sfrmt == null || tgtfrmt == null) {
	        ...
	        targetfmt = targetfmt.replace(/dd/, kony.os.padZero(parseInt(dateVal)));
	        targetfmt = targetfmt.replace(/mm/, kony.os.padZero(parseInt(monthVal)));
